...
pub(crate) fn size() -> io::Result<(u16, u16)> {
    if let Ok(window_size) = window_size() {
        // Let's add default (ANSI terminal) values in case when 'tcgetwinsize'
        // returns Ok with columns and/or rows equal to 0.
        //
        // In practice, Ok((0,0)) often results in crashes (frequently) or
        // rendering issues (more rarely) when running applications over a
        // serial line.
        //
        ...
        // fallbacks to defaults, and more.
        //
        // They use an enhanced and layered mechanism for detecting the terminal
        // dimensions, which seems to be implemented in this library.
        //
